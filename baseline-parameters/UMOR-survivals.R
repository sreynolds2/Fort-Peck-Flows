# THIS SCRIPT COMPUTES ANNUAL SURVIVALS FOR EACH TYPE OF RELEASED STOCKED 
# PS ANALYZED IN ROTELLA ET AL. 2017 AND WRITES THEM TO 
# baseline-parameters/Rotella_2017_phi.csv 

# THE MO_fing COLUMN (MISSOURI RIVER FINGERLINGS) OF THAT FILE IS USED
# WITH OTHER ESTIMATES FROM THE LITERATURE TO PRODUCE THE BASELINE 
# SURVIVALS USED FOR THE FORT PECK EIS, WHICH ARE STORED IN 
# dat/BaselinePhi.csv

### NOTES:  NEED TO DO YELLOWSTONE RIVER YEARLINGS
